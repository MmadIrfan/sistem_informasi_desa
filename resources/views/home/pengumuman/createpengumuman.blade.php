        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        <form action="{{ route('updatepengumuman.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tema') is-invalid @enderror"
                                    name="tema" value="{{ old('tema') }}" placeholder="Masukkan tema">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('konteks') is-invalid @enderror" name="konteks" rows="5"
                                    placeholder="Masukkan Konten Post">{{ old('konteks') }}</textarea>
